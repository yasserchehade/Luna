...
| --- | --- | --- | --- | --- |
| **Observe** | Connect one household email account; notice relevant email and supported attachments; preserve source references | Gmail and Outlook parity; calendar and message intake; source health and retry | Passive multi-source monitoring; household-specific source prioritisation | Building a full email client; broad connector catalogue before the first loop works |
| **Understand** | Read email and PDF/JPG/PNG attachments with OpenAI; assemble relevant household context, conversation and prior work; identify attention, facts and urgency | Correlate multiple messages and attachments; resolve entities across household history; better uncertainty explanations | Longitudinal household understanding; specialised reading competencies | Local models, local-only reasoning, multiple providers and BYOK |
...
| **Communicate** | Use conversation as the primary interface; explain findings; ask one focused question; propose a draft reply or reminder | Proactive briefs; multiple household members; concise channel-aware responses | Family coordination and adaptive communication preferences | A separate document chat; a scripted questionnaire presented as conversation |
...
| --- | --- |
| Gmail or Outlook | Incoming household information source |
...
| Cabinet and durable storage | Record and evidence support, not the product's work owner |
