...
| Unreadable Consent history cannot disable verified access | `verified_consent_lookup_skips_unreadable_history_without_reusing_it` keeps the strict Consent Grants screen warning, excludes unreadable grants from authorization and portable export, and allows settings, current verified permissions and new grants to continue safely |
