...
- preservation of one-time grants as historical authority using a canonical Document reference without rebinding them as executable consent on another device;
